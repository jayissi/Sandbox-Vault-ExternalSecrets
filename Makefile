...
help:
	...
	@echo "  USE_CONTAINER=false make lab-demo            # Run directly on host (skip container)"
	...
	@echo "    make lab-demo                              # Full lab container deployment with remote cluster login credentials"
